    ...
    <section className="sticky top-0 left-0 right-0 z-50 bg-white">
      <header className="container mx-auto px-5 flex items-center justify-between py-4">
        ...
        >
          ...
          {userState.userInfo ? (
            <div className="text-white lg:text-dark-soft flex flex-col items-center  gap-y-5 lg:flex-row gap-x-3 font-semibold">
              <div className="relative group">
                <div className="flex flex-col items-center">
                  <button
                    onClick={() => setProfileDropdown(!profileDropdown)}
                    className="flex items-center gap-x-1 mt-5 lg:mt-0 border-2 border-blue-500 px-6 py-2 rounded-full text-blue-500 font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300"
                  >
                    <span>Profile</span>
                    <MdKeyboardArrowDown />
                  </button>
